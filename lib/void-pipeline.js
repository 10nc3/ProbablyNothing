...
const { callWithFallback, PROVIDERS, DEFAULT_CHAIN, CONTEXT_LIMITS, estimateTokens, getStrikeStatus, getActiveChain } = require('./llm-client');
const { getContext, isForexQuery, detectForexPair, fetchForexRate, buildForexContext, isDesignQuestion, getDesignContext } = require('./intent-detector');
...
async function runPipeline(input) {
  ...
  // ── 3b. SAFETY GUARD (block dangerous patterns in prescribe mode) ──
