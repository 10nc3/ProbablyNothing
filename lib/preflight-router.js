...
const { getLegalAnalysisSeed, LEGAL_KEYWORDS_REGEX } = require('./legal-analysis');
const { detectForexPair, isForexQuery, fetchForexRate, buildForexContext, isDesignQuestion, getSystemContextForDesign } = require('./intent-detector');
const { getSeedMetricProxy, detectSeedMetricIntent } = require('../prompts/seed-metric');
const { detectCodeMode, getLanguageFromExtension } = require('./mode-registry');
